...
class Scraper:
    ...
    def stock_list(self):
        ...
        # stock list 저장
        kospidak_df.to_csv(self.path + "/stock_list.csv", encoding="cp949", index=False)

    def stock_history(self, years=10, path="/stock"):
        ...
        try:
            kospidak_df = pd.read_csv(self.path + "/stock_list.csv", encoding="cp949", index_col=0)
    ...
    def etf_history(self, years=10, path="/etf"):
        ...
        try:
            etf_list_df = pd.read_csv(self.path + "/etf_list.csv", encoding="cp949", index_col=0)
        except FileNotFoundError:
    ...
    def finance(self, path="/finance"):
        ...
        kospidak_df["PER"] = PER
        kospidak_df.to_csv(self.path + "/stock_list.csv", encoding="cp949")
